...
def _get_kwargs(
    *,
    ...
    url = "{}/admin/globalSettings/systemSettings".format(client.base_url)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[SystemSettings]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[SystemSettings]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        json_body (SystemSettings): Represents the System settings that affect core functionality
            of YouTrack.
