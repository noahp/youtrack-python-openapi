...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[List["VersionBundleElement"]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[List["VersionBundleElement"]]:
    return Response(
