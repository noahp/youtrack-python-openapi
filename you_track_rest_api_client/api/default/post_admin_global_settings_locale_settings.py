...
def _get_kwargs(
    *,
    ...
    url = "{}/admin/globalSettings/localeSettings".format(client.base_url)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[LocaleSettings]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[LocaleSettings]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        json_body (LocaleSettings): Represents the System Language settings.
