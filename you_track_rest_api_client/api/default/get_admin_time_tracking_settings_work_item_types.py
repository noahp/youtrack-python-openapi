...
def _get_kwargs(
    *,
    ...
    url = "{}/admin/timeTrackingSettings/workItemTypes".format(client.base_url)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[List["WorkItemType"]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[List["WorkItemType"]]:
    return Response(
