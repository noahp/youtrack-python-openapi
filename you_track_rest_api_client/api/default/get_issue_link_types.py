...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[List["IssueLinkType"]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[List["IssueLinkType"]]:
    return Response(
