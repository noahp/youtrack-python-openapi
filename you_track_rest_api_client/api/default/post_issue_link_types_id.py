...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/issueLinkTypes/{id}".format(client.base_url, id=id)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[IssueLinkType]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[IssueLinkType]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        json_body (IssueLinkType): Represents the settings of a link type in YouTrack.
