...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[List["EnumBundleElement"]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[List["EnumBundleElement"]]:
    return Response(
