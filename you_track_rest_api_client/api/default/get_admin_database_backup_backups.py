...
def _get_kwargs(
    *,
    ...
    url = "{}/admin/databaseBackup/backups".format(client.base_url)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[List["BackupFile"]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[List["BackupFile"]]:
    return Response(
